...
El repositorio ya incluye un mapa de ejemplo precalculado (`map720p D=5.npy`) con una resolución de 720p y un parámetro $D=5$. Si se desea modificar la resolución o las condiciones iniciales, puedes cambiar estos parámetros directamente en `geodesics.py`.
